        ...
        ZStack (alignment: .leading){
            ...
            VStack (alignment: .leading, spacing: 10) {
                ...
                HStack (alignment: .center, spacing: 13) {
                    Spacer()
                    StatBubbleView(title: "Hours", stat: 250, startColor: Color("Navy"), endColor: Color("Sky Blue"))
                    StatBubbleView(title: "Sessions", stat: 34, startColor: Color("Turtle Green"), endColor: Color("Lime"))
                    StatBubbleView(title: "Updates", stat: 290, startColor: Color("Maroon"), endColor: Color("Fucshia"))
